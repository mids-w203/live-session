...
<!--chapter:end:01-probability-spaces.Rmd-->
...
<!--chapter:end:02-random-variables.Rmd-->
...
<!--chapter:end:03-summarizing-distributions.Rmd-->
...
<!--chapter:end:04-conditional-expectation-and-BLP.Rmd-->
...
<!--chapter:end:05-sampling-theory.Rmd-->
...
<!--chapter:end:06-hypothesis-testing.Rmd-->
...
<!--chapter:end:07-comparing-two-groups.Rmd-->
...
<!--chapter:end:08-regression-estimation.Rmd-->
...
data[ , c('sqrft', 'sqrft_two')]


model_two <- lm(price ~ sqrft + lotsize, data = data)
model_two

model_three <- lm(sqrft ~ lotsize, data = data)
model_three

model_four <- lm(price ~ sqrft + sqrft_two, data = data)
...
coefci(model_one, level = 0.95, vcov. = vcovHC)
```
...
```{r}
mean(bootstrap_result < 0.10)
```

```{r}
data

wilcox.test(bdrms ~ colonial, data = data)
t.test(bdrms ~ colonial, data = data)
...
bs2 <- bootstrap_sqft(d = data_adam, 1000)
...
<!--chapter:end:09-regression-inference.Rmd-->
...
<!--chapter:end:10-descriptive-models.Rmd-->
...
<!--chapter:end:11-causal-models.Rmd-->
...
<!--chapter:end:12-classical-linear-model.Rmd-->
...
<!--chapter:end:13-reproducible-research.Rmd-->
...
<!--chapter:end:14-maximum-likelihood.Rmd-->
...
<!--chapter:end:15-blooms-taxonomy.Rmd-->
